...
class FilmActorSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('film_actor')->insert(['filmd_id' => $film_id->id ,'actor_id' => $actor_id->id]);
        ...
        DB::table('film_actor')->insert(['filmd_id' => $film_id->id ,'actor_id' => $actor_id->id]);
        $actor_id = DB::table('actors')->where('name','Alberto Ammann')-first();
        DB::table('film_actor')->insert(['filmd_id' => $film_id->id ,'actor_id' => $actor_id->id]);

        $film_id = DB::table('films')->where('name','Batman Begins')->first();
        $actor_id = DB::table('actors')->where('name','Liam Nesson')-first();
        DB::table('film_actor')->insert(['filmd_id' => $film_id->id ,'actor_id' => $actor_id->id]);
